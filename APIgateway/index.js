...
const REGISTRATION_SERVICE_URL = process.env.REGISTRATION_SERVICE_URL || 'http://3.95.216.168:5001';
const AUTH_SERVICE_URL = process.env.AUTH_SERVICE_URL || 'http://3.95.216.168:5002';
const ADMIN_SERVICE_URL = process.env.ADMIN_SERVICE_URL || 'http://13.217.222.156:5003';
const USER_SERVICE_URL = process.env.USER_SERVICE_URL || 'http://54.205.214.135:5004';
